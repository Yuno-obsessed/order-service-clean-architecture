package sanity.nil.product.domain.service;
...
import sanity.nil.product.domain.exceptions.UnsupportedRateException;
...
import static sanity.nil.common.domain.vo.Discount.DiscountType.BUY_TWO_PRICE_FOR_ONE;
import static sanity.nil.common.domain.vo.Discount.DiscountType.getByCode;
