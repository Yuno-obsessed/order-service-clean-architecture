package sanity.nil.order.onlineshop.domain.entity;
...
import sanity.nil.order.onlineshop.util.EntityGenerator;
...
import static sanity.nil.order.onlineshop.util.EntityGenerator.*;
...
public class OrderTest {
    ...
    public static void initTest() {
        product1 = new OrderProduct(UUID.randomUUID(), "Book", BigDecimal.valueOf(50.2), generateActiveDiscount(30), 3);
        product2 = new OrderProduct(UUID.randomUUID(), "Laptop", BigDecimal.valueOf(1345.67), generateActiveDiscount(50), 4);
        product3 = new OrderProduct(UUID.randomUUID(), "Headphones", BigDecimal.valueOf(234.89), generateExpiredDiscount(30), 1);
    ...
    public void addProductTest() {
        OrderProduct product4 = new OrderProduct(UUID.randomUUID(), "Keyboard", BigDecimal.valueOf(47.25), generateActiveDiscount(30), 2);
        int initialLength = order.getProducts().size();
