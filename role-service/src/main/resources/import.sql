...
INSERT INTO role_service.permissions(id, created_at, description, method, roles, service_name, uri, verb) VALUES (3, now(), 'desc', 'getProductByID', 'ROLE_ADMIN,ROLE_USER,NONE', 'order-service', '/api/v1/product', 'GET');
INSERT INTO role_service.permissions(id, created_at, description, method, roles, service_name, uri, verb) VALUES (4, now(), 'desc', 'getAllProducts', 'ROLE_ADMIN,ROLE_USER,NONE', 'order-service', '/api/v1/product/search', 'GET');
INSERT INTO role_service.permissions(id, created_at, description, method, roles, service_name, uri, verb) VALUES (5, now(), 'desc', 'addRating', 'ROLE_ADMIN, ROLE_USER', 'order-service', '/api/v1/product/statistics/addrate', 'PUT');
INSERT INTO role_service.permissions(id, created_at, description, method, roles, service_name, uri, verb) VALUES (6, now(), 'desc', 'addToWishList', 'ROLE_ADMIN, ROLE_USER', 'order-service', '/api/v1/product/statistics/addtowishlist', 'PUT');
