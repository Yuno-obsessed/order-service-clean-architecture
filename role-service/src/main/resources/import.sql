...
INSERT INTO role_service.permissions(id, created_at, description, method, roles, service_name, uri, verb) VALUES (5, now(), 'desc', 'addRating', 'ROLE_ADMIN', 'order-service', 'api/v1/product/addrate', 'PUT');
INSERT INTO role_service.permissions(id, created_at, description, method, roles, service_name, uri, verb) VALUES (6, now(), 'desc', 'addToWishList', 'ROLE_ADMIN', 'order-service', 'api/v1/product/addtowishlist', 'PUT');
